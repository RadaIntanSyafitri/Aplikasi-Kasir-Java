...
public class warungrada{
	public static void main(String[]args){
        login();}
        static void login (){
		String data[]={"RADA INTAN SYAFITRI","rada12345"};
		String nama,sandi;
		System.out.println("*****************************************************");
		System.out.println("||              TUGAS UJIAN AKHIR SEMESTER            ||");
    ...
    static void menu(){
		...
		System.out.println("3. Warung Rada");
...
static void jualan(){
        ...
        System.out.println("\n\n\n\n\n\n\n\n\n");
        System.out.println("            WELCOME TO RADA RESTO ");
        System.out.println("\n");
        System.out.println("           ************************************************");
        System.out.println("            ************************************************");
        System.out.println("            \n\n");
                System.out.println("                    PERUT KENYANG HATI PUN SENANG");
        ...
        System.out.println("            |2. Ayam Goreng Lado Ijo |   Rp 18000,00   |");
        System.out.println("            |3. Ayam goreng Biasa    |   Rp 13000,00   |");
        System.out.println("            |4. Nila Bakar           |   Rp 15000,00   |");
        System.out.println("            |5. Kapiek Ndak Batulang |   Rp 13000,00   |");
	    System.out.println("        	|6. Nila Goreng  |   Rp 14000,00   |");
        System.out.println("            |7. Bebek Cabe IJo       |   Rp 15000,00   |");
        System.out.println("            |8. Bebek Bakar          |   Rp 13000,00   |");
        System.out.println("            |9. Dendeng Batokok      |   Rp 12000,00   |");
        System.out.println("            |10.Gulai Ayam Kampung   |   Rp 15000,00   |");
         ...
         for (i=0; i<jum;i++){
              ...
              switch (kode[i]){
                    ...
                    case 7 : 
                            ...
                            break;
                    case 8 : 
                            barang[i]="Bebek Bakar";
                            harga[i]=13000;
                            diskon[i]=0;
                            break;
                    case 9 : 
                            barang[i]="Dendeng Batokok        ";
                            harga[i]=12000;
                            diskon[i]=0.2;
                            break;
                    case 10 : 
